...
public:
    ...
    {
        microMouseServer->setWindowTitle(QApplication::translate("microMouseServer", "microMouseServer", Q_NULLPTR));
        actionSave_Maze->setText(QApplication::translate("microMouseServer", "Save Maze", Q_NULLPTR));
        menu_startRun->setText(QApplication::translate("microMouseServer", "Start Run", Q_NULLPTR));
        actionTest->setText(QApplication::translate("microMouseServer", "test", Q_NULLPTR));
        menu_loadMaze->setText(QApplication::translate("microMouseServer", "Load Maze", Q_NULLPTR));
        menu_saveMaze->setText(QApplication::translate("microMouseServer", "Save Maze", Q_NULLPTR));
        menu_connect2Mouse->setText(QApplication::translate("microMouseServer", "Connect to Local Mouse", Q_NULLPTR));
        actionConnect_to_Remote_Mouse->setText(QApplication::translate("microMouseServer", "Connect to Remote Mouse", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tb_status), QApplication::translate("microMouseServer", "Status", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tb_debug), QApplication::translate("microMouseServer", "Debug", Q_NULLPTR));
        menuSystem->setTitle(QApplication::translate("microMouseServer", "File", Q_NULLPTR));
    } // retranslateUi
